...
public class TestJugadorYCartas {
	...
	public void testInicializarNombreInvalido() {
		Exception exception = assertThrows(Exception.class, () -> {
	        new Jugador(" ", 4, 5, Fichas.CIRCULO, ColoresDisponibles.AMARILLO, null);
		});
	...
	public void testInicializarCantidadesInvalidas() {
		Exception exception1 = assertThrows(Exception.class, () -> {
	        new Jugador("Pedro", 0, 5, Fichas.CIRCULO, ColoresDisponibles.AMARILLO, null);
		});
	    ...
	    Exception exception2 = assertThrows(Exception.class, () -> {
	    	new Jugador("Pedro", 1, -1, Fichas.CIRCULO, ColoresDisponibles.AMARILLO, null);
	    });
	...
	public void testEnumFichas() {
		Exception exception = assertThrows(Exception.class, () -> {
	        new Jugador("Pedro", 4, 5, null, ColoresDisponibles.AMARILLO, null);
		});
	...
	public void testRobarCartas() {
		...
		try {
			Jugador jugador = new Jugador("Juancito", 4, 3, Fichas.CIRCULO, ColoresDisponibles.AMARILLO, cartas); //3: cantCartasMax
